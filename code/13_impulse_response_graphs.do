...
graph export "$outpath/FImpRes_k_income.png", as(png) replace
...
graph export "$outpath/FImpRes_k_enrollment.png", as(png) replace
...
graph export "$outpath/FImpRes_k_pop.png", as(png) replace
...
graph export "$outpath/FImpulseResposne.png", as(png) replace
} 
